package clases.clase_8.inputOuput;
...
public class Ingreso {
    ...
    public static int datoEntero(String cMensaje, String cTitulo, int icono) {
        ...
        do {
            try {
                String input = JOptionPane.showInputDialog(null, "Ingrese un número entero:",cTitulo,icono);
    ...
    public static String datoString(String cMensaje, String cTitulo, int icono) {
        ...
        do {
            try {
                cadena = JOptionPane.showInputDialog(null, "Ingrese una cadena de texto:",cTitulo,icono);
